...
const getStaticProps = async ()=>{
    ...
    const hitProducts = await src_services_product_service__WEBPACK_IMPORTED_MODULE_6__/* ["default"].getByFlag */ .Z.getByFlag("isHit");
    return {
        revalidate: 60,
        props: {
            categories,
...
const Catalog = ({ categories , hitProducts  })=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [210,505,664,121,675,310,679,497,686,411,853,152,535,78,874,577,822], () => (__webpack_exec__(2250)));
